...
function ecCheckCookie()
{
    ...
    {     
        ...
        $("#bg-switcher-css").attr("href", "/demo-4/css/backgrounds/" + bgID + ".css");
    }
    ...
    if (darkMode != "")
    {
        var $link = $('<link>', {
            rel: 'stylesheet',
            href: '/demo-4/css/dark.css',
            class: 'dark'
        });
        
        $("link[href='/demo-4/css/responsive.css']").before($link);
    ...
    else
    {
        ...
        if (themeColor != "")
        {
            ...
            if(themeColor != '01'){
                $("link[href='/demo-4/css/responsive.css']").before('<link rel="stylesheet" href="/demo-4/css/skin-'+themeColor+'.css" rel="stylesheet">');
            }
        }
    }
}
...
/*--------------------- Trend Product Slider -------------------------------- */    
    ...
    $('.ec-change-color').on('click', 'li', function(){
        $('link[href^="/demo-4/css/skin-"]').remove();
        $('link.dark').remove();
        ...
        if(dataValue != undefined){
            $("link[href='/demo-4/css/responsive.css']").before('<link rel="stylesheet" href="/demo-4/css/skin-'+dataValue+'.css" rel="stylesheet">');
